      ...
      for (let l = 0; l < 10; l++) {
        await prisma.risk.create({
          data: {
            ...
            timeProbability: faker.helpers.arrayElement([
              1,
              2,
              3,
              4,
            ...
            timeConsequence: faker.helpers.arrayElement([
              1,
              2,
              3,
              4,
            ...
            economicProbability: faker.helpers.arrayElement([
              1,
              2,
              3,
              4,
            ...
            economicConsequence: faker.helpers.arrayElement([
              1,
              2,
              3,
              4,
